...
<a href="{{ route('insert_physio') }}" class="btn btn-primary">Add Counsellor</a>
 <a href="{{ route('physio_list') }}" class="btn btn-primary">Manage Counsellor</a>
@else
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-info">
                <div class="panel-heading">Add Counsellor</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('add_physio') }}" enctype="multipart/form-data">
                         {{ csrf_field() }}
